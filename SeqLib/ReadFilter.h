...
namespace SeqLib
{
    ...
    namespace Filter
    {
        ...
        public:
             ...
             */
            void SetRuleID(const std::string& s)
            {
                id = s;
            };
             ...
             */
            void SetReadGroup(const std::string& rg)
            {
                read_group = rg;
            }
        ...
        public:
             ...
             */
            void SetExcluder(bool e)
            {
                excluder = e;
            }

            /** Set as a mate linked region */
            void SetMateLinked(bool e)
            {
                m_applies_to_mate = e;
            }
